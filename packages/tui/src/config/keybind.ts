...
export const Definitions = {
  ...
  panel_select_chat: keybind("1", "Focus chat panel"),
  panel_select_files: keybind("2", "Focus files panel"),
  panel_select_mcp: keybind("3", "Focus MCP panel"),
  panel_select_lsp: keybind("4", "Focus LSP panel"),
  panel_select_todo: keybind("5", "Focus todo panel"),
  panel_select_context: keybind("6", "Focus context panel"),
...
export const CommandMap = {
  ...
  panel_select_chat: "session.panel.chat",
  panel_select_files: "session.panel.files",
  panel_select_mcp: "session.panel.mcp",
  panel_select_lsp: "session.panel.lsp",
  panel_select_todo: "session.panel.todo",
  panel_select_context: "session.panel.context",
