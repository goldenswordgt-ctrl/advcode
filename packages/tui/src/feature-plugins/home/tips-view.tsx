...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent ADVCode from reading sensitive files",
  "Use {highlight}advcode run{/highlight} for non-interactive scripting",
  "Use {highlight}advcode --continue{/highlight} to resume the last session",
  "Use {highlight}advcode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}advcode serve{/highlight} for headless API access to ADVCode",
  "Use {highlight}advcode run --attach{/highlight} to connect to a running server",
  "Run {highlight}advcode upgrade{/highlight} to update to the latest version",
  "Run {highlight}advcode auth list{/highlight} to see all configured providers",
  "Run {highlight}advcode agent create{/highlight} for guided agent creation",
  "Use {highlight}/advcode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}advcode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/advcode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}advcode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with ADVCode Zen for curated, tested models",
